...
def reset_run_root(args,run_root):
    ...
    args.tensorboard_dir = "{}/{}/log".format(run_root, args.dataname)
    args.checkpoint_dir = "{}/{}/checkpoint".format(run_root, args.dataname)
    args.metic_dir = "{}/{}/".format(run_root, args.dataname)
